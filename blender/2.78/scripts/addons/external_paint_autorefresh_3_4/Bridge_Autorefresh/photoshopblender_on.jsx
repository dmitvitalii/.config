...
///////////////////////
function blenderAutorefresh(runid){
	...
	message.onResult = function(r){
	    ...
	    b1+="desc22.putString( idjsNm, \"\"\"Blender Autorefresh Save\"\"\" );";
...
function blenderAutorefreshMenu(){
    ...
    this.menuCommandID = "blenderphotoshop_on";
    var menu_element = new MenuElement("menu", "Blender Autorefresh", "at the end of tools", menuID);
    var menu_command = new MenuElement("command", "On", "at the end of "+menuID, menuCommandID);
	...
	var taskid = app.scheduleTask("blenderAutorefresh("+runid+")", pause_time, true);
